...
function inspectFn (fnInspect /* : function */) /* : string */ {
    return (fnInspect.name) ? fnInspect.name : fnInspect.toString();
}

function inspectArgs (argsInspect) /* : string */
{
...
function curry(fnCurryMe /* : function */) /* : function */
{
    var arity = fnCurryMe.length;

    return function fnCurried() /* : function */
    {
        ...
        if (args.length >= arity) {
            ...
            fnCurryPartial.toString = function toString () /* : string */ {
...
var id = function (identity /* : function */) /* : function */
{
    return identity;
};
...
var toUpperCase = function toUpperCase (str /* : string */) /* : string */
{
    return str.toUpperCase();
};

var toLowerCase = function toLowerCase (str /* : string */) /* : string */
{
