...
function defineSuite() {
    describe('xray summarize inheritance for an object', function () {
        describe('xray :: a → [String]', function () {
            var xray = R.curry(function (testIt, expected, explain, value) {
                ...
                obj2 = { girth: 'huge', id: '192'};

            Object.setPrototypeOf(obj, obj2);
            Object.setPrototypeOf(obj2, { top: 'daddy', cid: 'c45'});
            ...
            it('should identify an anonymous function', function () {
                expect(F.xray(function () {}))
                    .to.deep.equal(['Function', 'Function.prototype', 'Object.prototype']);
            });
            it('should identify a named function', function () {
                expect(F.xray(function namedFn () {}))
                    .to.deep.equal(['Function namedFn', 'Function.prototype', 'Object.prototype']);
            });
            it('should identify an array', function () {
                expect(F.xray([])).to.deep.equal(['Array', 'Array.prototype', 'Object.prototype']);
            });
            it('should identify an object', function () {
                expect(F.xray({})).to.deep.equal(['Object', 'Object.prototype']);
            });
            it('should identify an double inherited object', function () {
                expect(F.xray(obj)).to.deep.equal(['Object fred', 'Object 192', 'Object c45', 'Object.prototype']);
            });
            it('should identify an inherited object', function () {
                expect(F.xray(obj2)).to.deep.equal(['Object 192', 'Object c45', 'Object.prototype']);
            });
            it('should identify the Window object', function () {
                expect(F.xray(window)).to.deep.equal(['Window CodePen', 'Window', 'EventTarget', 'Object.prototype']);
            });
            it('should identify the document object', function () {
                expect(F.xray(document))
                    .to.deep.equal(["HTMLDocument #document", "HTMLDocument", "Document", "Node", "EventTarget", "Object.prototype"]);
            });
...
function defineCode() {
    ...
    F.xrayScan = function (obj, ancestry) {
        /* jshint maxcomplexity: 19, maxdepth: 6 */
        ...
        var proto,
            ...
            inherit = function (type, obj) {
                ...
                if (obj && !/ /.test(typeName)) {
                    var prop, idx, named = null;
                    // first try with hasOwnProperty but some native objects will fail
                    for (idx = 0; idx < nameProperties.length; idx += 1) {
                        prop = nameProperties[idx];
                        try {
                    ...
                    // fall back to a normal property lookup if still no name found
                    if (named === null) {
                        for (idx = 0; idx < nameProperties.length; idx += 1) {
                            prop = nameProperties[idx];
                            try {
